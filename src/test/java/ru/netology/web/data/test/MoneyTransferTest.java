...
public class MoneyTransferTest {
    ...
    public void shouldTransferMoneySingleOwner() {
        ...
        var depositInfo = getDepositInfo();
        ...
        int firstCardBalanceExpected = initialFirstCardBalance + getDepositInfo().getAmount();
        int secondCardBalanceExpected = initialSecondCardBalance - getDepositInfo().getAmount();
